...
LIBS += $$PWD/libs/linux_ubuntu/log/libboost_log.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_filesystem.a
LIBS += $$PWD/libs/linux_ubuntu/libboost_system.a
LIBS += $$PWD/libs/linux_ubuntu/libboost_thread.a
#LIBS += $$PWD/libs/linux_ubuntu/log/libboost_log_setup.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_atomic.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_chrono.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_container.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_context.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_coroutine.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_date_time.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_exception.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_graph.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_iostreams.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_locale.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_program_options.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_random.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_regex.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_serialization.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_signals.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_timer.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_type_erasure.a
#LIBS += $$PWD/libs/linux_ubuntu/libboost_wave.a
