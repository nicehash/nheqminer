...
vmovdqa xword [rdi+EH.mids+0x80], xmm0
vmovdqa xword [rdi+EH.mids+0x90], xmm1
vmovdqa xword [rdi+EH.mids+0xa0], xmm2
vmovdqa xword [rdi+EH.mids+0xb0], xmm3
vmovq xmm8, [rsi+0x80]
vpshufd xmm4, xmm8, 0x44
vmovdqa xword [rdi+EH.mids+0xc0], xmm4
...
vpshufd xmm6, xmm6, 0xb1
	vmovq [rdi+EH.mids+0x08], xmm6	;v12
vpshufd xmm7, xmm7, 0xb1
vpaddq xmm4, xmm4, xmm6
	vmovq [rdi+EH.mids+0x10], xmm4	;v8
vpaddq xmm5, xmm5, xmm7
vpxor xmm2, xmm2, xmm4
vpxor xmm3, xmm3, xmm5
vpshufb xmm2, xmm2, xmm10
	vmovq [rdi+EH.mids+0x18], xmm2	;v4
vpshufb xmm3, xmm3, xmm10

vpaddq xmm0, xmm0, xmm2
	vmovq [rdi+EH.mids], xmm0	;v0
vpaddq xmm1, xmm1, xmm3
	vpextrq [rdi+EH.mids+0x60], xmm1, 1	;v3
;add message (nonce, index) to xmm0 here, but we don't have
vpxor xmm6, xmm6, xmm0
vpxor xmm7, xmm7, xmm1
vpshufb xmm6, xmm6, xmm11
vpshufb xmm7, xmm7, xmm11
	vmovdqa xword [rdi+EH.mids+0x40], xmm7	;v14,15
vpaddq xmm4, xmm4, xmm6
	vpextrq [rdi+EH.mids+0x70], xmm4, 1	;v9
vpaddq xmm5, xmm5, xmm7
...
vpalignr xmm2, xmm3, xmm8, 8	;xmm2 resume
	vmovdqa xword [rdi+EH.mids+0x20], xmm2	;v5,6
vpsrldq xmm3, xmm3, 8
	vmovq [rdi+EH.mids+0x68], xmm3		;v7
vpsrldq xmm7, xmm6, 8
vpaddq xmm0, xmm0, xmm2
	vpextrq [rdi+EH.mids+0x30], xmm0, 1	;v1
vpaddq xmm1, xmm1, xmm3
	vmovq [rdi+EH.mids+0x78], xmm1		;v2
vpxor xmm7, xmm7, xmm1
vpshufd xmm7, xmm7, 0xb1
	vmovq [rdi+EH.mids+0x38], xmm7		;v13
