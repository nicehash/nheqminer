# Donation
If you like what im doing consider donating BTC to 18KXbLfgVt9zLxEuboPCmjpuvLL7VtjPhm (maztheman)
and/or 1AJdfCpLWPNoAMDfHF1wD5y8VgKSSTHxPo (tpruvot)
...
- Tested with Visual Studio 2013 Update 4 and 5 installed
- 64 bit version only
